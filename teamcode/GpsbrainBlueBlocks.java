...
public class GpsbrainBlueBlocks extends LinearOpMode {
  ...
  private double[] args = new double[]{ 900, -90, 400, 0};
  private boolean[] isArgs = new boolean[]{true,true, true, false};
  ...
  public GpsbrainBlueBlocks(Drive drive, BNO055IMU acc, Chomp c, Find find, SciLift scl, Arm a) {
    d = drive;
